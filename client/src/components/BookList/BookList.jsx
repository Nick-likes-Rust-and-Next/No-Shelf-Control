...
import { QUERY_BOOK_ID } from "../../utils/queries";
...
function BookList() {
    ...
    const { loading, error, data } = useQuery(QUERY_BOOK_ID, {
        variables: { ids: user.books },
    });
    let userBooks = [];
